...
class RecipeCard extends HTMLElement {
	...
	constructor() {
		...
		let article_element=document.create('article');
		// A3. TODO - Create a style element - This will hold all of the styles for the Web Component
		let style_element=document.create('style');
		...
		shadow.append(article_element);
		shadow.append(style_element);
	}
	...
	set data(data) {
		...
		article_element.innerHTML=`<img src="https://link-to-article.com/recipe-thumbnail.jpg"
		alt="Recipe Title">
	  <p class="title">
